...
export const metadata = {
  title: "Teambuilding Équicoaching — Cohésion d'équipe par le vivant",
  description: "Journée teambuilding équicoaching pour révéler et transformer les dynamiques de votre équipe. Île-de-France.",
}
...
const schedule = [
  ...
  { time: '18h00', title: 'Clôture & Engagements',     desc: "Engagements individuels et collectifs, remise du livret de restitution." },
]
    ...
    <>
      ...
      <section className="bg-violet-fonce min-h-[70vh] flex items-center relative overflow-hidden">
        ...
        <div className="container relative z-10 pt-32 pb-20">
          <FadeIn>
            <p className="text-or font-inter font-semibold text-sm tracking-widest uppercase mb-4">Teambuilding Équicoaching</p>
          </FadeIn>
          ...
          <FadeIn delay={0.3}>
            <p className="text-white/80 text-lg font-inter mb-10 max-w-2xl leading-relaxed">
              Une journée hors du commun qui révèle les dynamiques de votre équipe comme aucune formation conventionnelle ne peut le faire.{' '}
          ...
          <FadeIn delay={0.5} className="flex flex-wrap gap-6 mt-10 text-white/60 font-inter text-sm">
            ...
            <span className="flex items-center gap-2"><Check className="w-4 h-4 text-or" /> Aucune expérience équestre requise</span>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <FadeIn direction="right">
              <p className="text-or font-inter font-semibold text-sm tracking-widest uppercase mb-4">Prêt pour l&apos;expérience ?</p>
              ...
              <p className="text-gris-moyen font-inter mb-8 leading-relaxed">
                Nous adaptons chaque journée à la taille et aux enjeux spécifiques de votre équipe.
                Aucune expérience avec les chevaux nécessaire — c'est même souvent ce qui rend la journée encore plus révélatrice.
              </p>
              <MagneticButton href="/audit-gratuit">
